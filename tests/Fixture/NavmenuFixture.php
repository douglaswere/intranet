 ...
 *
 */
class NavmenuFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'navmenu_ibfk_1' => ['type' => 'foreign', 'columns' => ['navmenu_id'], 'references' => ['navmenu', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'navmenu_ibfk_2' => ['type' => 'foreign', 'columns' => ['store_id'], 'references' => ['stores', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
