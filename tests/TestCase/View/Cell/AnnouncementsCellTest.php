...
use App\View\Cell\AnnouncementsCell;
use Cake\TestSuite\TestCase;

/**
 * App\View\Cell\AnnouncementsCell Test Case
 */
class AnnouncementsCellTest extends TestCase
{
     ...
     * Test subject
     *
     * @var \App\View\Cell\AnnouncementsCell
     */
    ...
    public function setUp()
    {
        ...
        $this->Announcements = new AnnouncementsCell($this->request, $this->response);
    }
