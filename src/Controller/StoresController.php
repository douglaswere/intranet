...
class StoresController extends AppController
{
    ...
    public function view($id = null)
    {
        $store = $this->Stores->get($id, [
            'contain' => ['ParentStores', 'Files', 'Navmenus', 'StoreDivisions', 'StoreIpmaps', 'StoreReturns', 'StoreSortfield', 'StoreVars', 'ChildStores']
        ]);
    ...
    public function add()
    {
        ...
        $this->set(compact('store', 'parentStores', 'files'));
    }
